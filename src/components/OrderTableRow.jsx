                ...
                <tr className="bg-[#faf8f5] border-b border-gray-100">
                    <td colSpan="7" className="py-6 px-8">
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            {/* Right Side: Special Instructions Box */}
                            <div className="w-full md:w-1/3 bg-orange-50 border border-orange-100 p-5 rounded-xl shadow-sm h-fit">
                                ...
                                <p className="text-gray-700 text-sm leading-relaxed">
                                    {order.special_instructions && order.special_instructions !== 'None'
                                        ...
                                        : <span className="italic text-gray-400">No special instructions provided.</span>}
                                </p>
                            </div>
